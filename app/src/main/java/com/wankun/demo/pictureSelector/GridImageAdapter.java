...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.glide_filter_image,
                viewGroup, false);
...
//                        .apply(options)
    ...
    public void addAllPosition(Collection elem , int position){
        if (elem == null) {
            elem = new ArrayList();
        }
        list.addAll(position , elem);
        notifyDataSetChanged();
    }
    /**
     * 删除某个数据
     ...
     * @param elem list数据
     */
    public void replaceAll(List<LocalMedia> elem) {
        list.clear();
        if (elem != null) {
            list.addAll(elem);
        }
